...
public class SpamatronicTest {
	...
	@Test
	public void test0() {
		String[] knownSpam = new String[] {"This is a vile piece of spam."};
		String[] newMail = new String[] {"Spam is spiced ham.",
 "Spam is VILE!",
 "Spam is not vile."};
		assertArrayEquals(new int[] { 0 }, new Spamatronic().filter(knownSpam, newMail));
	}
	
	@Test
	public void test1() {
		String[] knownSpam = new String[] {"We have the best mortgage rates. Refinance today.",
 ...
 "All-new pics: Stacy, Tiffany, Donner, and Blitzen."};
		String[] newMail = new String[] {"5000 bucks for shoes?",
 ...
 "Don't Feel Short; try Elevator Shoes for increase.",
 "All-new pics: Stacy, Tiffany, Donner, and Blitzen."};
		String[] newMail = new String[] {"On, Dasher! On, Dancer! On, Donner and Blitzen!"};
		assertArrayEquals(new int[] { 0 }, new Spamatronic().filter(knownSpam, newMail));
	}
 ...
 "Don't Feel Short; try Elevator Shoes for increase.",
 "All-new pics: Stacy, Tiffany, Donner, and Blitzen."};
		String[] newMail = new String[] {"Try the prime ribs.",
 ...
 "Try the prime ribs."};
	...
	@Test
	public void test4() {
		String[] knownSpam = new String[] {"One, two, buckle my shoe.",
 "Eins, zwei, polizei.",
 "On the first day of Christmas, my true love",
 "gave to me a partridge in a pear tree."};
		String[] newMail = new String[] {"Christmas shoe buckle madness!",
 "Partridge polizei madness day!",
 "I did not shoot the deputy.",
 "The second day of Christmas, a partridge bit me."};
		assertArrayEquals(new int[] { 2 }, new Spamatronic().filter(knownSpam, newMail));
	}
	
	@Test
	public void test5() {
		String[] knownSpam = new String[] {"ArnQ iGue ORAr tYMK GLPK pcdV QCOQ TJGj JFgv QuDv ",
 ...
 "Rtbd oCEF xECT VOZP aKdp ARuG ZyqG BpOx KiZg VwjP ",
 "Rtbd oCEF xECT VOZP aKdp ARuG ZyqG BpOx KiZg VwjP "};
		String[] newMail = new String[] {"qXsI hRfD viBk KGOk GLPK kFYM WSEe oCEF ysrX Gicz ",
 ...
 "SFED Ybsv ootQ QCOQ DTQd pcdV kCXI TAzJ zVEu QCOQ "};
		assertArrayEquals(new int[] { 1,  2,  3,  5,  8,  9,  11,  13,  14,  18,  19,  22,  24,  26,  28,  31,  32,  33,  36,  42,  43,  44 }, new Spamatronic().filter(knownSpam, newMail));
	}
}
